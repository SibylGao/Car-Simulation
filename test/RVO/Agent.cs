    ...
    internal class Agent
    {
        ...
        internal void computeNewVelocity()
        {
            ...
            for (int i = 0; i < agentNeighbors_.Count; ++i)
            {
                ...
                Vector2 relativePosition = other.position_ - position_;//0
                Vector2 relativeVelocity = velocity_ - other.velocity_;//0///////////////////////////////////////

                if(position_.x()==0&&position_.y()==0)
                {
                    //Debug.LogError("position=0");
                }
                if (velocity_.x() == 0 && velocity_.y() == 0)
                {
                    //Debug.LogError("velocity_=0");
                }
         ...
         * 在指定的直线上解决一维线性规划的问题，这是由直线和圆的线性约束所决定的
         * constraint.</summary>
         *
        ...
        private bool linearProgram1(IList<Line> lines, int lineNo, float radius, Vector2 optVelocity, bool directionOpt, ref Vector2 result)
        {
            ...
            if (directionOpt)
            {
                ...
                {
                    /* Take left extreme. */
                    result = lines[lineNo].point + tLeft * lines[lineNo].direction;///////////////出错///////////////
                }
